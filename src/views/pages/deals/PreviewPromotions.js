...
const PreviewPromotions = () => {
    ...
    const onDateInputChange = (value, flag) => {
      ...
      searchTransaction(load.key, load.dataInput, load.dataInput1)
    }
    ...
    const searchTransaction = (key, data, data1) => {
      ...
      staticTransactions.forEach(transaction => {
        if (transaction.name.toLowerCase().includes(key.toLowerCase())) {
         if (transaction.date_of_purchase >= data && transaction.date_of_purchase <= data1) {
                ...
                <CCol md="6" sm="12">
                    <CCard>
                        <CCardBody>
                            ...
                            <div className="title-input mt-3 mb-4">
                                ...
                                <CFormGroup variant="custom-checkbox" className="mr-0" inline>
                                    <CInputCheckbox 
                                        custom 
                                        id="company-logo-checkbox" 
                                        name="company-logo-checkbox" 
                                        checked = {dealItems.companyInfo}
                                        onChange = {() => {}}
                                    />
                                    <CLabel variant="custom-checkbox" className="company-logo-label" htmlFor="company-logo-checkbox" >Display company contact information</CLabel>
                                </CFormGroup>
                            </div>
                            <div className="title-input">
                            ...
                            <div className="title-input row">
                              ...
                              <div className="mobile-preview">
                                  ...
                                  <div className="mobile-content p-3">
                                    <CRow>
                                      <CCol className="mobile-content-section" md="7" sm="12">
                                        ...
                                        <CLabel id="mobile-preview-job" className="mobile-letter">Games and Hobbies Shop</CLabel>
                                      </CCol>
                                  ...
                                  <div className="mobile-content p-3">
                                    ...
                                    <CLabel className="details-label mb-0" id="parti-branch-1"><CIcon name="cil-envelope-closed" />sample@email.com</CLabel>
                                    <CLabel className="details-label mb-0" id="parti-branch-2"><CIcon name="cil-envelope-closed" />+1565962656</CLabel>
                                    <CLabel className="details-label mb-0" id="parti-branch-3"><CIcon name="cil-envelope-closed" />www.sample.com</CLabel>
                                  </div>
                                </div>
                              </CCol>
