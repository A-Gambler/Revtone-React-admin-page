                    ...
                    <CCard>
                        <CCardBody>
                            ...
                            <div className="title-input">
                                ...
                                <CInput id="original-price" value = {originPrice} onChange={e => { setOriginPrice(e.target.value) }} name="original-price" placeholder="" />
                            </div>
                            <div className="title-input">
                                <CLabel htmlFor="promotional-price">Promotional Price</CLabel>
                                <CInput id="promotional-price" value = {promotionPrice} onChange={e => { setPromotionPrice(e.target.value) }} name="promotional-price" placeholder="" />
                            </div>
                            <div className="title-input">
